  ...
  return (
    <div>
      ...
      <div className='relative flex items-center group'>
        ...
        <div id={'slider'} className='relative flex w-full h-full overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide'>
            {movies.map((item, id) => (
                <div>
                <div key={id} className='w-[160px] sm:w-[200px] md: x-[240px] lg:x-[280px] inline-block cursor-pointer relative p-4'>
                  <img className='w-full h-auto block' src={`https://image.tmdb.org/t/p/w500/${item?.img}`} alt={item?.id}/>
